...
@Composable
private fun ProductItemRow(modifier: Modifier = Modifier, product: Product? = null) {
    Card(
        modifier = Modifier.height(120.dp),
        colors = CardDefaults.cardColors(containerColor = Color.White)
    ) {
        Column(modifier = Modifier.padding(4.dp).fillMaxHeight(), verticalArrangement = Arrangement.spacedBy(4.dp)) {
...
private fun ProductListPreview() {
    ProductList(products = listOf(Product(id = 1, title = "Wonderful skin cream")))
}